...
namespace Cattac.Character.Ability
{
    public class FloatingObjectMaker : Ability
    {
        ...
        [Header("Tilt Animation")] [SerializeField]
        float _tiltAmount = 5f;
        ...
        private void Update()
        {
            ...
            _currentObject.transform.position = Vector3.Lerp(_currentObject.transform.position, new Vector3(
                _currentObject.transform.position.x, transform.position.y,
        ...
        public override void UseAbility(CharacterHead user)
        {
            ...
            Physics.SphereCast(_currentTargetPosition, _sphereCastRadius, Vector3.down, out RaycastHit hit,
                Mathf.Infinity, _objectsLayer);
        ...
        {
            AntoineFoucault.Utilities.GizmoExtensions.DrawSphereCast(_currentTargetPosition, _sphereCastRadius,
